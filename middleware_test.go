...
func TestMiddlewareEventStore(t *testing.T) {
	t.Run("no middleware: store works unchanged", func(t *testing.T) {
		inner := &mwMockStore{}
		store := NewMiddlewareEventStore(inner)
...
func TestMiddlewareEventStoreExecution(t *testing.T) {
	inner := &mwMockStore{}
	var out []string

	store := NewMiddlewareEventStore(inner)
	store.Use(EventStoreMiddleware(func(next EventStore) EventStore {
...
func TestMiddlewareEventStoreOrder(t *testing.T) {
	inner := &mwMockStore{}
	var order []string
...
func TestMiddlewareEventStoreFuncAndStruct(t *testing.T) {
	inner := &mwMockStore{}
